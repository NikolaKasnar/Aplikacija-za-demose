...
<?php require_once __DIR__ . '/../_header.php'; ?>
    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        ...
        <form method="post" action="index.php?rt=upute/printanje">
            <label for="edited_content">Upute za printanje u praktikumima:</label><br>
        ...
        <form action="index.php?rt=upute/printanjeSlikeUplaod" method="post" enctype="multipart/form-data">
        ...
        <form action="index.php?rt=upute/printanjeSlikeDelete" method="post">
