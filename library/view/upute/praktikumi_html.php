...
<?php require_once __DIR__ . '/../_header.php'; ?>
    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        <h2>Praktikumi</h2>
        Molim vas koristite prelazak u novi red radi ljepšeg ispisa.
        <br><br>
        <?php if (!empty($error_message)) : ?>
            <p style="color: red;"><?php echo $error_message; ?></p>
        <?php endif; ?>
        <form method="post" action="index.php?rt=upute/praktikumi">
            <label for="edited_content">Upute za dežurstva u praktikumima:</label><br>
        ...
        <form action="index.php?rt=upute/praktikumiSlikeUplaod" method="post" enctype="multipart/form-data">
        ...
        <form action="index.php?rt=upute/praktikumiSlikeDelete" method="post">
